...
my_label2 = Label(bg=YELLOW, fg=GREEN)
my_label2.grid(column=2, row=4)

# Creating buttons

start_button = Button(text="Start", command=start_timer, font=(FONT_NAME))
start_button.grid(column=1, row=3)

reset_button1 = Button(text="Reset", command=reset_timer, font=(FONT_NAME))
reset_button1.grid(column=3, row=3)
